...
class TestLogic:
    ...
    def test_late_arrival(self):
        ing = datetime(2024,6,15,10,30); evt = datetime(2024,6,15,10,0)
    ...
    def test_dedup(self):
        recs = [{"id":"a","ts":1},{"id":"a","ts":2},{"id":"b","ts":1}]
        seen = {}
